...
type
  TfrmTriangle = class(TForm)
    ...
    procedure tNewPointTimer(Sender: TObject);
  private
...
begin
  ...
  Canvas.MoveTo(MidPoint.X - 1, MidPoint.Y);
  ...
  tNewPoint.Enabled := True;
end;

procedure TfrmTriangle.tNewPointTimer(Sender: TObject);
var
  iNum, iX, iY : Integer;
begin
  iNum := Random(3) + 1;
  ...
  MidPoint.X := (ArrPoints[iNum, 2] + iX) div 2;
  MidPoint.Y := (ArrPoints[iNum, 1] + iY) div 2;
