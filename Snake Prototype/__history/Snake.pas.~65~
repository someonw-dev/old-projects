...
procedure TfrmSnake.Button2MouseEnter(Sender: TObject);
begin
  sButtonName := 'Button2';
  MouseEnter;
end;

procedure TfrmSnake.Button2MouseLeave(Sender: TObject);
begin
  MouseLeave;
end;
...
procedure TfrmSnake.Button3MouseEnter(Sender: TObject);
begin
  sButtonName := 'Button3';
  MouseEnter;
end;

procedure TfrmSnake.Button3MouseLeave(Sender: TObject);
begin
  MouseLeave;
end;
